  ...
  return db
    .prepare(`
      SELECT stores.*, users.name AS owner_name, users.email, users.phone AS owner_phone,
             ...
             seller_verification_profiles.identity_proof_url AS seller_identity_proof_url,
             seller_verification_profiles.face_verified AS seller_face_verified,
             seller_verification_profiles.face_reference AS seller_face_reference,
             seller_verification_profiles.student_id AS seller_student_id,
             seller_verification_profiles.business_description AS seller_business_description,
             seller_verification_profiles.pickup_location AS seller_pickup_location,
             seller_verification_profiles.location_area AS seller_location_area,
             seller_verification_profiles.whatsapp_phone AS seller_whatsapp_phone,
      ...
      GROUP BY stores.id, users.name, users.email, users.phone,
               ...
               seller_verification_profiles.identity_proof_url,
               seller_verification_profiles.face_verified,
               seller_verification_profiles.face_reference,
               seller_verification_profiles.student_id,
               seller_verification_profiles.business_description,
               seller_verification_profiles.pickup_location,
               seller_verification_profiles.location_area,
               seller_verification_profiles.whatsapp_phone,
    ...
    .map((row) => ({
      ...
      identityProofUrl: row.seller_identity_proof_url || null,
      faceVerified: Boolean(row.seller_face_verified),
      faceReference: row.seller_face_reference || "",
      studentId: row.seller_student_id || "",
      businessDescription: row.seller_business_description || "",
