...
type StatusValue = AssignmentStatus | PaymentStatus | RiderStatus | Availability | VerificationStatus | CashReconciliationStatus | 'Delivered' | 'PAID' | 'UNPAID';
...
export default function StatusBadge({ value, pulse = false }: { value: StatusValue; pulse?: boolean }) {
  return (
